...
def mk_parser_main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="Bern",
        help="specifies whether binary or continuous-valued "
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="name of the injected variable (column) in the csv file",
    )
    parser.add_argument(
        "--meta_data_csv",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="dimension to inject to input of the decoder from annotation",
    )
    parser.add_argument(
        "--digits_from_mnist",
        nargs="*",
