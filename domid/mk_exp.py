...
def mk_exp(task, model, trainer: str,train_domain:str, test_domain:str, batchsize: int, nocu=True, prior = 'Gaus',
            random_batching=False,
            model_method='cnn',
            feat_extract='vae', pre_tr =5, epos=10,
           inject_var = None, dim_inject=0):
    """
